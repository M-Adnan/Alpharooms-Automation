...
{
    [TestFixture]
    public class UkFlightsSmokeTests : AlpharoomsTestBase
    {
        [Test]
        [Category("UK_QA_Flights_SmokeTest")]
        public void ShouldBookFlight_For2Adults_ForDestination_Benidorm()
        {
            //Enter search criteria on home page and click search
            HomePage.SearchFor().FlightOnly().ToDestination("Benidorm").FromCheckIn(Calendar.PickRandomCheckInDate()).ToCheckOut(Calendar.PickRandomCheckOutDate())
